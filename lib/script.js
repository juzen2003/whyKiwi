...
let eduImg = "http://icdn.kiwicrate.com/site/home/why-kiwico-educational.jpg";
...
function updateButtonStyle(btn, img) {
  btn.style.backgroundColor = "#21B5BF";
  btn.style.color = "#ffffff";
}
function resetButtonStyle() {
  let arr = [convenientButton, sparksButton, educationalButton, familyButton, funButton, alternativeButton];
  for(let i = 0; i < arr.length; i++) {
    arr[i].style.backgroundColor = "";
    arr[i].style.color = "#21B5BF";
  }
}
